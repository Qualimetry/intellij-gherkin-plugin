...
version = providers.gradleProperty("pluginVersion").getOrElse("1.3.8")
...
dependencies {
    ...
    implementation("com.qualimetry.sonar:gherkin-analyzer:1.4.2")
...
intellijPlatform {
    pluginConfiguration {
        ...
        description = """
            ...
            <ul>
              <li>86 rules covering structure, design, style, tags, variables, and spelling</li>

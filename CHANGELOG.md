...
- New tool window showing the full rule description for a finding.
- SonarQube import uses the server's default quality profile when none is given and reports missing or empty profiles clearly.

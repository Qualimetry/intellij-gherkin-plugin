 ...
 * <p>
 * Ensures all 86 rules are registered, no rule key collides with reserved keys,
...
class ParityValidationTest {
    ...
    void allRulesRegistered() {
        assertThat(CheckList.getAllChecks()).hasSize(86);
    }
    ...
    void defaultProfileHasExpectedSize() {
        // 55 rules in default profile (includes 75, 80, 83, 84, 86).
        assertThat(CheckList.getDefaultRuleKeys()).hasSize(55);
    }
